...
namespace VehicleRequisitionSystem.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Designation,IsDeleted")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Designation,IsDeleted")] Employee employee)
        {
            if (ModelState.IsValid)
            {
