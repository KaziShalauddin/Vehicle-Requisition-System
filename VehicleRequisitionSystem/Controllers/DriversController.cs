...
namespace VehicleRequisitionSystem.Controllers
{
    public class DriversController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,CheckInTime,DepartureTime,Status,IsDeleted")] Driver driver)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,CheckInTime,DepartureTime,Status,IsDeleted")] Driver driver)
        {
            if (ModelState.IsValid)
            {
