...
namespace VehicleRequisitionSystem.Controllers
{
    public class OrganizationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,IsDeleted")] Organization organization)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,IsDeleted")] Organization organization)
        {
            if (ModelState.IsValid)
            {
