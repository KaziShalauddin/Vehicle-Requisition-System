...
namespace VehicleRequisitionSystem.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,IsDeleted,OrganizationId")] Department department)
        {
            ...
            ViewBag.OrganizationId = new SelectList(db.Organizations, "Id", "Name", department.OrganizationId);
            return View(department);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,IsDeleted,OrganizationId")] Department department)
        {
            if (ModelState.IsValid)
            {
