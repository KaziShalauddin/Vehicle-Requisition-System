...
namespace VehicleRequisitionSystem.Controllers
{
    public class DesignationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,DepartmentId")] Designation designation)
        {
            ...
            ViewBag.DepartmentId = new SelectList(db.Departments, "Id", "Name", designation.DepartmentId);
            return View(designation);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,DepartmentId")] Designation designation)
        {
            if (ModelState.IsValid)
            {
